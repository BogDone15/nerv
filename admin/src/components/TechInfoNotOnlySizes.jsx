...
export const TechInfoNotOnlySizes = ({
	prodctInfo,
	setProdctInfo,
	checkedOnlySizes,
	currentProduct,
	...
	useEffect(() => {
		if (pathName) {
			const productsWithSizes = currentProduct?.options.filter(item =>
	...
	}, [currentProduct?.options, currentProduct.sizeChart.length, pathName]);
