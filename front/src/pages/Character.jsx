...
export const Character = () => {
	...
	useEffect(() => {
		const fetchData = async () => {
			const prodcutTypeArmor = category.find(item => item.type === 'armor');
			const prodcutModelArmor = data.find(item => item.model === 'armor');

			prodcutTypeArmor && setActiveelement(prodcutTypeArmor.id);
			prodcutModelArmor && setActiveitem(prodcutModelArmor._id);
		};
